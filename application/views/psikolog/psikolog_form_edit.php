                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="<?=site_url('psikolog/update')?>" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                            <div class="col-md-6 mb-3 mb-md-0">
                                                <div class="form-group">
                                                    <input type="hidden" name="idpsikiater" value="<?=$this->input->post('idpsikiater') ?? $row->idpsikiater ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3 mb-md-0">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="spesialisasi" class="form-control <?=form_error('spesialisasi') ? 'is-invalid' : null ?>" id="spesialisasi" value="<?=$this->input->post('spesialisasi') ?? $row->spesialisasi ?>">
                                                    <div class="invalid-feedback">
