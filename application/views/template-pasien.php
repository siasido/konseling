                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" data-toggle="dropdown"
                                ...
                                <?php if ($this->session->userdata('foto') != null) { ?>
                                    <img src="<?=base_url('uploads/user/'.$this->session->userdata('foto'))?>" width="25" class="profile-pic rounded-circle"> 
                                <?php } else { ?>
                                ...
                                <ul class="dropdown-user list-style-none">
                                    <li>
                                        <div class="dw-user-box p-3 d-flex">
                                            <div class="u-img">
                                                    <?php if ($this->session->userdata('foto') != null) { ?>
                                                        <img src="<?=base_url('uploads/user/'.$this->session->userdata('foto'))?>" class="rounded" width="80"> 
                                                    <?php } else { ?>
            ...
            <div class="scroll-sidebar">
                <div class="user-profile position-relative" style="background: url(<?php echo base_url()?>assets/src/assets/images/background/user-info.jpg) no-repeat;">
                    ...
                    <div class="profile-text pt-1"> 
                        <a href="#" class=" text-white d-block" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><?php echo $this->session->userdata('nama')?></a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item <?=$active_menu == 'keluhan' ? 'active' : null?>"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?=$active_menu == 'keluhan' ? 'active' : null?>" href="<?=site_url('keluhanPasien/keluhansaya')?>" aria-expanded="false">
                                <i class="mr-2 mdi mdi-voice"></i><span class="hide-menu">Keluhan</span>
                            </a>
                        </li>
