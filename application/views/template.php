        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="<?=base_url('dashboard/dashboardAdmin')?>">
                        <!-- Logo icon -->
                        <b class="logo-icon">
                            <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
                            <!-- Dark Logo icon -->
                            <!-- <img src="<?php echo base_url()?>assets/logo.png" alt="homepage" class="dark-logo" /> -->
                            <!-- Light Logo icon -->
                            <!-- <img src="<?php echo base_url()?>assets/logo-mini.png" style="width:80px; height:50px" alt="homepage" class="light-logo" /> -->
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="<?php echo base_url()?>assets/logo.png" width="50%" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                            <img src="<?php echo base_url()?>assets/logo.png" style="width:150px; height:50px" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
            ...
            <div class="scroll-sidebar">
                <div class="user-profile position-relative" style="background: url(<?php echo base_url()?>assets/src/assets/images/background/user-info.jpg) no-repeat;">
                    ...
                    <?php if ($this->session->userdata('foto') != null) { ?>
                        <img src="<?=base_url('uploads/user/'.$this->session->userdata('foto'))?>" class="rounded w-100"> 
                    <?php } else { ?>
                        <img src="<?=base_url('assets/no_image.jpg')?>" class="rounded" width="80"> 
                    <?php } ?>
                     </div>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item <?=$active_menu == 'psikolog' ? 'active' : null?>"> 
                            ...
                            <i class="fas fa-user-md"></i><span class="hide-menu">Psikolog</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?=$active_menu == 'pasien' ? 'active' : null?>"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?=$active_menu == 'pasien' ? 'active' : null?>" href="<?=site_url('pasien/index')?>" aria-expanded="false">
                                <i class="mdi mdi-face"></i><span class="hide-menu">Pasien</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?=$active_menu == 'soal' ? 'active' : null?>"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?=$active_menu == 'soal' ? 'active' : null?>" href="<?=site_url('mastersoal/index')?>" aria-expanded="false">
                                <i class="mdi mdi-content-paste"></i><span class="hide-menu">Bank Soal</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item <?=$active_menu == 'keluhan' ? 'active' : null?>"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?=$active_menu == 'keluhan' ? 'active' : null?>" href="<?=site_url('keluhanpasien/listkeluhan')?>" aria-expanded="false">
                                <i class="mdi mdi-content-paste"></i><span class="hide-menu">Keluhan Pasien</span>
                            </a>
                        </li>

                        <!-- <li class="sidebar-item <?=$active_menu == 'hasil' ? 'active' : null?>"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?=$active_menu == 'hasil' ? 'active' : null?>" href="<?=site_url('konseling/data')?>" aria-expanded="false">
                                <i class="mdi mdi-content-paste"></i><span class="hide-menu">Hasil Test</span>
                            </a>
                        </li> -->
                    </ul>
                </nav>
