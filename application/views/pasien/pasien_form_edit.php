            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Pasien</h3>
            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12">
                        <div class="card card-body">
                            ...
                            <p class="text-muted mb-4 font-13">Isi form untuk mengedit data pasien</p>
                            <div class="row">
                                                ...
                                                <div class="el-element-overlay">
                                                    <div class="el-card-item pb-3">
                                                        ...
                                                        <?php if ($row->foto != null) { ?>
                                                            <a class="image-popup-vertical-fit" href="<?=base_url('uploads/user/'.$row->foto)?>"> <img src="<?=base_url('uploads/user/'.$row->foto)?>" class="d-block position-relative" width="150px" alt="user"> </a>
                                                        <?php } else { ?>
